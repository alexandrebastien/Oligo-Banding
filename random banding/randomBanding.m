% randomBanding generates semi-random colors to make a chromosome barcode
...
%   probes, and detect by FISH microscopy. randomBanding will avoid pattern
...
% Main function
function ct = randomBanding(csvConf,csvOut)
